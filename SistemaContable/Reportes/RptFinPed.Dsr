VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptFinPed 
   Caption         =   "SIGC - RptFinPed (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptFinPed.dsx":0000
End
Attribute VB_Name = "RptFinPed"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Preparaciones.pdf"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Preparaciones.xls"
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
...
Private Sub Detail_BeforePrint()
   If txtped_fecfin.Text = "01/01/1900" Then
      txtped_fecfin.Text = ""
   End If
End Sub
