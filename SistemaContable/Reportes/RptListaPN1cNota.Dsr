VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptListaPN1cNota 
   Caption         =   "SIGC - RptListaPN1cNota (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   20460
   _ExtentX        =   36089
   _ExtentY        =   19076
   SectionData     =   "RptListaPN1cNota.dsx":0000
End
Attribute VB_Name = "RptListaPN1cNota"
...
Private Sub Detail_BeforePrint()
   ...
   If Field2.Visible = False And Field3.Visible = False Then
      txtlis_articC1.Width = txtlis_articC1.Width + (Field2.Width + Field3.Width)
   Else
      If Field2.Visible = False And Field3.Visible = True Then
         txtlis_articC1.Width = 3735
         txtlis_articC1.Width = txtlis_articC1.Width + (Field2.Width)
      Else
...
'   End If
   ...
   If RNumber = 68 Then 'If there are 6 records on the page
