VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptCategoriaPro 
   Caption         =   "SIGC - RptCategoriaPro (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptCategoriaPro.dsx":0000
End
Attribute VB_Name = "RptCategoriaPro"
