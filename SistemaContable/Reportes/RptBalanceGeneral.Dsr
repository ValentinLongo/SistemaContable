VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptBalanceGeneral 
   Caption         =   "SIGC - RptBalanceGeneral (ActiveReport)"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   ...
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "RptBalanceGeneral.dsx":0000
End
Attribute VB_Name = "RptBalanceGeneral"
...
Private Sub Detail_Format()
    txtbal_saldo.Text = String((tabulador.Text - 1) * 6, " ") & txtbal_saldo.Text
    txtbal_descri.Text = String((tabulador.Text - 1) * 6, " ") & txtbal_descri.Text
End Sub
