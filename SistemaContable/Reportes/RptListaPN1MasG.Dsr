VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptListaPN1MasG 
   Caption         =   "SIGC - RptListaPN1MasG (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   20400
   _ExtentX        =   35983
   _ExtentY        =   19076
   SectionData     =   "RptListaPN1MasG.dsx":0000
End
Attribute VB_Name = "RptListaPN1MasG"
...
Private Sub Detail_BeforePrint()
   ...
   If txtaux_ctrl1 = "X" Then
      ...
      tit1.Style = "font-size: 9pt; font-family: 'Times New Roman'; ddo-char-set: 0; font-weight: bold;"
   ...
   Else
      ...
      txtlis_articC1.Style = "font-size: 9pt; font-family: 'Times New Roman'; ddo-char-set: 0;"
   ...
   If frm_filtrogralL.chk_renglon.Value = 0 Then RptListaPN1MasG.Line2.Visible = False
End Sub
...
'   If txt_param1.Text <> "2" Then
   ...
   If Field2.Visible = False And Field3.Visible = False Then
      txtlis_articC1.Width = 4819 + (Field2.Width + Field3.Width)
   Else
      If Field2.Visible = False And Field3.Visible = True Then
         txtlis_articC1.Width = 4819
         txtlis_articC1.Width = 4819 + (Field2.Width) - 50
      Else
         txtlis_articC1.Width = 4819
      End If
   End If
   If Field2.Visible = True Then
      If Field3.Visible = False Then
         Label17.Caption = "Tipo Emb."
...
'   End If
   ...
   If RNumber = 59 Then 'If there are 6 records on the page
