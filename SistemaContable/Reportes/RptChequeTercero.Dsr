VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptChequeTercero 
   Caption         =   "SIGC - RptChequeTercero (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptChequeTercero.dsx":0000
End
Attribute VB_Name = "RptChequeTercero"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Cheques de Tercero.pdf"
...
On Error GoTo fin
   ...
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.FileName = "Cheques de Tercero.xls"
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
      Err.Clear
      Exit Sub
...
Private Sub Detail_BeforePrint()
   If txtcht_fecbaja <> "01/01/1900" Then
      fecbaja.Text = txtcht_fecbaja.Text
   Else
      fecbaja.Text = ""
   End If
End Sub
...
Private Sub PageFooter_BeforePrint()
   ...
   If Field3 <> Total Then
      Label1.Caption = "Sub-Cantidad:"
      Label2.Caption = "Sub-Total:"
   Else
      Label1.Caption = "Cantidad:"
