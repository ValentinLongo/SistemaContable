VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptResumenImpVta 
   Caption         =   "SIGC - RptResumenImpVta (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptResumenImpVta.dsx":0000
End
Attribute VB_Name = "RptResumenImpVta"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "ResumenxImputacion.pdf"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "ResumenxImputacion.xls"
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
...
Private Sub Detail_BeforePrint()
   If Not txtimp_acumulado.Text = "" Then
      acum = txtimp_acumulado.Text
   End If
End Sub
...
Private Sub ReportFooter_BeforePrint()
   lbl_salfin.Text = Format(CDec(acum), "0.00")
