VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptAuditUsu1 
   Caption         =   "SIGC - RptAuditUsu1 (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptAuditUsu1.dsx":0000
End
Attribute VB_Name = "RptAuditUsu1"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Auditoria por Usuario.pdf"
...
On Error GoTo fin
   ...
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.FileName = "Auditoria por Usuario.xls"
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
      Err.Clear
      Exit Sub
