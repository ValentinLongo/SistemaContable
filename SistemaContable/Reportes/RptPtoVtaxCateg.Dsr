VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptPtoVtaxCateg 
   Caption         =   "SIGC - RptPtoVtaxCateg (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptPtoVtaxCateg.dsx":0000
End
Attribute VB_Name = "RptPtoVtaxCateg"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Puntos de Venta x Categoria.pdf"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Puntos de Venta x Categoria.xls"
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
