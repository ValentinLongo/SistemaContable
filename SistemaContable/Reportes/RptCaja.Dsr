VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptCaja 
   Caption         =   "SIGC - RptCaja (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Cajas.pdf"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Cajas.xls"
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
