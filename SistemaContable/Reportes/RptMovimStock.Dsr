VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptMovimStock 
   Caption         =   "SIGC - RptMovimStock (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptMovimStock.dsx":0000
End
Attribute VB_Name = "RptMovimStock"
...
Private Sub Detail_BeforePrint()
   If txtmov_ing.Text = "0" Then txtmov_ing.Text = ""
   If txtmov_egr.Text = "0" Then txtmov_egr.Text = ""
End Sub
