VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptRentabxFLR 
   Caption         =   "SIGC - RptRentabxFLR (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptRentabxFLR.dsx":0000
End
Attribute VB_Name = "RptRentabxFLR"
...
Private Sub PageFooter_BeforePrint()
   ...
   Else
      Field3 = Format(Round(((CDec(Field1) - CDec(Field2)) * 100) / (CDec(Field1)), 3), "0.000")
   End If
End Sub
