VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptPlaCtas 
   Caption         =   "RptPlaCtas (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15240
   _ExtentX        =   26882
   _ExtentY        =   19076
   SectionData     =   "RptPlaCtas.dsx":0000
End
Attribute VB_Name = "RptPlaCtas"
...
Private Sub Detail_BeforePrint()
   If CInt(txtpcu_tabulador.Text) > 1 Then
      txtpcu_descri.Text = String((CInt(txtpcu_tabulador.Text) - 1) * 7, " ") & txtpcu_descri.Text
   End If
End Sub
