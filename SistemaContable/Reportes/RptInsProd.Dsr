VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptInsProd 
   Caption         =   "SIGC - RptInsProd (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptInsProd.dsx":0000
End
Attribute VB_Name = "RptInsProd"
...
Private Sub Detail_BeforePrint()
   If txtinp_aputil.Text = 1 Then
      Field1.Text = "SI"
   Else
      Field1.Text = "NO"
   End If
   
   If txtinp_tipo.Text = 1 Then
      Field2.Text = "IMPORTE"
   Else
      Field2.Text = "PORCENTAJE"
   End If
