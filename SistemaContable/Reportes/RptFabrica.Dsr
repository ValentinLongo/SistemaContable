VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptFabrica 
   Caption         =   "SIGC - RptFabrica (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptFabrica.dsx":0000
End
Attribute VB_Name = "RptFabrica"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Fábricas.pdf"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Fábricas.xls"
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
...
Private Sub Detail_Format()
   If txtfab_coefcosto.Text = "0,000000" Then
      txtfab_coefcosto.Text = ""
   End If
   If txtfab_coefventa.Text = "0,000000" Then
      txtfab_coefventa.Text = ""
   End If
   If txtfab_coefmino.Text = "0,000000" Then
      txtfab_coefmino.Text = ""
   End If
   If txtfab_coefmayo.Text = "0,000000" Then
      txtfab_coefmayo.Text = ""
   End If
End Sub
