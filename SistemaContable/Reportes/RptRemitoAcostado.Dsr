VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptRemitoAcostado 
   Caption         =   "SIGC - RptRemitoAcostado (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   20460
   _ExtentX        =   36089
   _ExtentY        =   19076
   SectionData     =   "RptRemitoAcostado.dsx":0000
End
Attribute VB_Name = "RptRemitoAcostado"
...
'   Texto271.Caption = Texto271.Caption & " " & ParSimbolo
'   Texto272.Caption = Texto271.Caption & " " & ParSimbolo
'
'   Set tNum2Text = New cNum2Text
'   LeyTot1.Text = UCase(ParMonedaD) & ": " & UCase(tNum2Text.Numero2Letra(txtvta_total1.Text, , 2, "", "", Masculino, Masculino)) & "."
'   LeyTot2.Text = UCase(ParMonedaD) & ": " & UCase(tNum2Text.Numero2Letra(txtvta_total2.Text, , 2, "", "", Masculino, Masculino)) & "."
End Sub
