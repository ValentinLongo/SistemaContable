VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptConceptoCon 
   Caption         =   "SIGC - RptConceptoCon (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptConceptoCon.dsx":0000
End
Attribute VB_Name = "RptConceptoCon"
...
Private Sub Detail_BeforePrint()
   If txtcoc_vta.Text = "1" Then
      Field1.Text = "SI"
   Else
      Field1.Text = "NO"
   End If

   If txtcoc_cpa.Text = "1" Then
      Field2.Text = "SI"
   Else
      Field2.Text = "NO"
   End If

   If txtcoc_caja.Text = "1" Then
      Field3.Text = "SI"
   Else
      Field3.Text = "NO"
   End If
