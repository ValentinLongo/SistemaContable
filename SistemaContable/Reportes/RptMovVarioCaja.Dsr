VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptMovVarioCaja 
   Caption         =   "SIGC - RptMovVarioCaja (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptMovVarioCaja.dsx":0000
End
Attribute VB_Name = "RptMovVarioCaja"
...
Private Sub ReportFooter_BeforePrint()
   Field2.Text = Format(CDec(Field1.Text) - CDec(Field3.Text), "0.00")
End Sub
