VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptCliente 
   Caption         =   "SIGC - RptCliente (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptCliente.dsx":0000
End
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Listado de Clientes.pdf"
...
Private Sub Detail_BeforePrint()
   If txtcli_fecultcpa.Text = "01/01/1900" Then
      txtcli_fecultcpa.Text = ""
   End If
End Sub
