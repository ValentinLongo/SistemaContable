VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} RptConsulArticCP 
   Caption         =   "SIGC - RptConsulArticCP (ActiveReport)"
   ClientHeight    =   10815
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   15360
   _ExtentX        =   27093
   _ExtentY        =   19076
   SectionData     =   "RptConsulArticCP.dsx":0000
End
Attribute VB_Name = "RptConsulArticCP"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Artículos.pdf"
...
On Error GoTo fin
   ...
   Menu.Dialog1.FileName = "Artículos.xls"
   On Error Resume Next
   Menu.Dialog1.CancelError = True
   Menu.Dialog1.ShowSave
   If Err.Number = 32755 Then
...
Private Sub Detail_Format()
   If txtart_coefcosto.Text = "0,000000" Then
      txtart_coefcosto.Text = ""
   End If
   If txtart_coefventa.Text = "0,000000" Then
      txtart_coefventa.Text = ""
   End If
   If txtcat_coef.Text = "0,000000" Then
      txtcat_coef.Text = ""
   End If
   If txtart_coefmino.Text = "0,000000" Then
      txtart_coefmino.Text = ""
   End If
   If txtart_coefmayo.Text = "0,000000" Then
      txtart_coefmayo.Text = ""
   End If
End Sub
