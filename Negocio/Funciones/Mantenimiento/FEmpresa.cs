...
namespace Negocio
{
    public class FEmpresa
    {
        ...
        public static DataSet listaEmpresa()
        {
            ...
            queryEmpresa = "Select Empresa.*, (emp_cuit1 + '-' + emp_cuit2 + '-' + emp_cuit3) as Cuit , (CONVERT(VARCHAR,emp_codpos1) + ' - ' + loc_nombre) as loc_nombre, iva_condicion  From Empresa Left join Tipempresa on emp_tipo = tem_codigo Left join Localidad on emp_codpos1 = loc_cod1 and emp_codpos2 = loc_cod2 Left Join CondIva on emp_iva = iva_codigo";
